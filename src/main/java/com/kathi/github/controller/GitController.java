...
public class GitController {
    ...
    @PostMapping("/author")
    public Author getAuthor(@RequestBody Map<String, Object> reqData){
        return gitService.getAuthor(reqData);
    }
    ...
    public Repository getRepositories(@RequestBody Map<String, Object> reqData){
        return gitService.getRepositories(reqData);
    }
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "not found!!!"),
            @ApiResponse(code = 415, message = "Un supported media format!!!") })
    public Repository getBranches(@RequestBody Map<String, Object> reqData){
        return gitService.getBranches(reqData);
    }
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "not found!!!"),
            @ApiResponse(code = 415, message = "Un supported media format!!!") })
    public List<Repository> getAllRepositoriesAndBranches(@RequestBody Map<String, Object> reqData){
        return gitService.getAllUserInfo(reqData);
    }
}
